...
export interface UploadZoneProps {
  ...
  isAI?: boolean
  /**
   * Comprobación extra, sincrónica, después de que pasa la validación de
   * tipo y tamaño. Devuelve un mensaje para rechazar la selección y mostrarlo
   * en línea en vez de agregar los archivos; null para aceptarla.
   */
